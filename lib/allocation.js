 ...
 *
 * Adds an HTTP route where a server allocation can be requested. It validates
 * the request, then passes it on to an algorithm pipeline to filter down the
 * servers to the most suitable server to fulfill the request.
 */
