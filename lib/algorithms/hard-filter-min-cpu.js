...
function filterMinCpu(log, state, servers, vmDetails, imgDetails, pkgDetails) {
    var filter;
    ...
    if (pkgDetails.overprovision_cpu) {
        var requestedCpu = vmDetails.cpu_cap / pkgDetails.overprovision_cpu;
