...
function filterMinRam(log, state, servers, vmDetails, imgDetails, pkgDetails) {
    var filter;

    if (pkgDetails.overprovision_ram) {
        var requestedRam = vmDetails.ram / pkgDetails.overprovision_ram;
