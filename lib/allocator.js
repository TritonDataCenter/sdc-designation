...
var DEFAULT_DESC = [
    'pipe', 'hard-filter-overprovision-ratio',
            'hard-filter-min-ram',
            'hard-filter-running',
            'hard-filter-setup',
 ...
 * overprovision ratio (see the hard-filter-overprovision-ratio.js top comment
...
function (servers) {
    for (var i = 0; i != servers.length; i++) {
        ...
        var vms = server.vms;
        var overprovisionRatio = server.overprovision_ratio || 1.0;
        ...
        for (var j = 0; j != vmUuids.length; j++) {
            ...
            var ram = vm.max_physical_memory / overprovisionRatio;
