 ...
 * hostname: headnode
 * memorytotalbytes: 2943930368
 * memoryavailablebytes: 1544368128
 * reserved: true
 * cpucores: 2
 * os: 20120319T230411Z
...
function validServer(server) {
  ...
  if (!server.memoryavailablebytes)
    throw new restify.MissingParameterError(
              'Server does not have a memoryavailablebytes attribute');

  if (!server.memorytotalbytes)
    throw new restify.MissingParameterError(
              'Server does not have a memorytotalbytes attribute');
