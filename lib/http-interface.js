...
function (req, res, next) {
    ...
    if (image.requirements) {
        ...
        msg = validatePlaformLimits(requirements, 'min_platform');
        if (msg)
            return next(new invalidErr(msg));

        msg = validatePlaformLimits(requirements, 'max_platform');
        if (msg)
            return next(new invalidErr(msg));
    }
 ...
 */
function validatePlaformLimits(requirements, requirementName) {
