...
function (req, res, next) {
    ...
    var vm = req.params.vm;
    var image = req.params.image;
    var overprovision = vm.overprovision_ratio;
...
function validateServer(server) {
    ...
    if (server.overprovision_ratio &&
        typeof (server.overprovision_ratio) !== 'number')
        return 'Server ' + sUuid + ' "overprovision_ratio" is not a number';
...
function validateVm(vm) {
    ...
    if (vm.overprovision_ratio && typeof (vm.overprovision_ratio) !== 'number')
        return 'VM "overprovision_ratio" is not a number';
