...
function (t) {
    ...
    var expectedReasons = {
        'f07f6c2c-8f9c-4b77-89fe-4b777dff5826':
            'Package gave no disk overprovision ratio, but server has ratio 1',
...
function (t) {
    ...
    var expectedReasons = {
        '79cc8d8a-1754-46d7-bd2c-ab5fe7f8c7bf':
            'VM\'s calculated 5120 disk is less than server\'s spare 2560',
        '9324d37d-e160-4a9d-a6d8-39a519634398':
            'VM\'s calculated 5120 disk is less than server\'s spare 5110'
    };
    t.deepEqual(reasons, expectedReasons);
