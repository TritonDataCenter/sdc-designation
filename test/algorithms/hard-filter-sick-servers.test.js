...
function (t) {
    var givenServers = [ {
        ...
        // should be included because both failures weren't in the past 24h
    ...
    var expectedServers = [ givenServers[0], givenServers[1], givenServers[3],
                            givenServers[4], givenServers[5], givenServers[6] ];
    var state = {};
...
exports.filterSickServers_with_no_servers =
function (t) {
    var state = {};
